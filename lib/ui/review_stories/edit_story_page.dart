...
class EditStoryPage extends GetView<EditStoryController> {
  ...
  noChanges() {
    Get.dialog(
      AlertDialog(title: const Text('Error'), content: const Text('No existen cambios en la información.'), actions: [
        OutlinedButton(
            onPressed: () {
              Get.back();
            },
  ...
  saveData() async {
    ...
    if (await controller.updateStory(story)) {
      ...
      Get.dialog(
        AlertDialog(title: const Text('Éxito'), content: const Text('La información ha sido modificada.'), actions: [
          OutlinedButton(
              onPressed: () {
                Get.back();
              },
      ...
      Get.dialog(
        AlertDialog(title: const Text('Error'), content: const Text('La información no ha sido modificada.'), actions: [
          OutlinedButton(
              onPressed: () {
                Get.back();
              },
